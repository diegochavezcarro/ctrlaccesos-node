...
const Personas = [{
    Numero: 'OK', Nombre: '', TipoIngreso: '', TipoIngresoDesc: '', Tarjeta: '', TarjetaEstado: '', GrupoFamiliar: ''
    , FechaNacimiento: '', NumeroDocumento: '', EstadoSocio: '', EstadoSocioDesc: '', Categoria: ''
}];

//const WSData = [{ Status: 'OK', ErrMessage: '', Data: '' }];
